    ...
    <div class="container" >
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive" style="margin-top:20px;" >
            <ul class="navbar-nav text-uppercase ml-auto">
              <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#"style="font-weight:bold; text-decoration:underline;">Accueil</a></li>
              <div class="dropdown">
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about" style="font-weight:bold;text-decoration:underline;">Le technopark</a></li>
              ...
              <div class="dropdown">
                ...
                <div class="dropdown">
                 ...
                 <li class="nav-item"><a class="nav-link js-scroll-trigger" href="./contact.html"style="font-weight:bold;text-decoration:underline;">Nous Contacter</a></li>
                 ...
                 <li class="nav-item"><a class="nav-link js-scroll-trigger" href="./espace admin/login.php"style="font-weight:bold;text-decoration:underline;">Espace admin</a></li>              
