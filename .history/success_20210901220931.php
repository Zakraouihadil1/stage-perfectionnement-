...
#success .icon{
    ...
    <body>
            ...
            <div class="icon">
              <i class="fa fa-smile-o" aria-hidden="true" style="font-size:60px; color:fff; margin-left:400px; "></i>
            </div>
            ...
            <i class="fa fa-times succ" aria-hidden="true" ><a href="../S2T/espace admin/login.php"></a></i>
      </section>
