...
catch (Exception $e)
{
        die('Echec lors de la connexion : ' . $e->getMessage());
						...
						if (isset($_POST['submit'])){
							$mc=$_POST['username'];
							$reqSelect="select * from masterlogin where username like '%mc%' ";
						}
						else{

							$reqSelect=$bdd->query('SELECT * FROM masterlogin');
						}
						  ...
						  while($services=$reqSelect->fetch()){
							   ...
							   echo "</td><td>";
								  ...
								  echo "<a  href='delete-users.php?id=".$services['id']."'  class='text-danger'><i class='fa fa-fw fa-trash' onclick='return confirm('Are you sure you want to delete this item')'></i>Delete</a>";
								  echo "</td><td>";
