  ...
  <nav class="navbar navbar-expand-lg  fixed-top" id="mainNav" style="background-color:white;">
    <div class="container" >
        <a class="navbar-brand " href="#page-top" style="float:left;">
            <img src="images/Logo-S2T png.png" width="100px;" height="100px" style="margin-left:30px;">
        </a>
            ...
            <ul class="navbar-nav text-uppercase ml-auto">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown">
                 ...
                 <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#"style="font-weight:bold;text-decoration:underline;">Tech Transfer</a></li>
                 <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../S2T/espace admin/"style="font-weight:bold;text-decoration:underline;">Espace admin</a></li>              
