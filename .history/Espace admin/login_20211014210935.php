...
if (isset($_POST['username']) && isset($_POST['password'])) {
  if(($_POST['username']=='') && ($_POST['password']=='') ){
      echo '<b style=color:red >Enter username and password !!</b>';
        }
 ...
 <nav class="navbar navbar-expand-lg  fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand " href="#page-top">
            <img src="../images/Logo-S2T png.png" width="140px" height="100px">
        </a>
  ...
  <div id="container">
            ...
            <img src="../images/people.png" width="70px" height="70px" style="margin-left:130px;;">

                <h1><i> <b style="font-family:bodoni;">Log In<b></i></h1>
