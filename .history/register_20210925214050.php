...
label.radio {
  ...
  <nav class="navbar navbar-expand-lg  fixed-top" id="mainNav" style="background-color:white;">
    <div class="container" >
        ...
        <img src="images/Logo-S2T png.png" width="125px" height="110px" style="margin-left:-25px;" >
        </a>
            ...
            <ul class="navbar-nav text-uppercase ml-auto">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown">
                 ...
                 <li class="nav-item"><a class="nav-link js-scroll-trigger" href="../S2T/espace admin/loginphp" style="font-weight:bold;text-decoration:underline;">Espace admin</a></li>              
    ...
    <div class="main-block" style="margin-top:90px;">
      ...
      <form action="" method="POST">
        ...
        <div class="info">
          ...
          <input class="fname" type="text" name="birthdate" placeholder="birthdate" required>
          <div class="gender">
...
<div class="container">
<p style="color: white; font-weight: bold; font-size: 17px;">Vous voulez avoir régulièrement de nos nouvelles ? <br>
